// Program 7.15 An inproved calculator
...
int main(void)
{
    ...
    printf("To use this calculator, enter any expression with or without spaces.");
        ...
        while(index<buf_length)
        {
            ...
            switch(op)
            {
                ...
                case '^':        // raise to a power
                    ...
                    break;
                default:        // invalid operation or bad inpout
                    printf("\n\n\aIllegal operation!\n");
                    break;
            }
        }
